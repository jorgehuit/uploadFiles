...
public class LeerXML {
	...
	public static void cargarXml(String route) {
	...
	public static void cargarXmlStandalone(String route) {
		// Se crea un SAXBuilder para poder parsear el archivo
		SAXBuilder builder = new SAXBuilder();
		File xmlFile = new File(route);
		try {
			...
			// Se obtiene la lista de hijos de la raiz 'tables'
			List list = rootNode.getChildren("server [Namespace: urn:jboss:domain:4.0]");
	...
	public static void main(String args []){
		cargarXml("C://Users//Huit//Documents//archivo.xml");
		cargarXmlStandalone("C://Directory1//standalone.xml");
	}
